...
namespace SmartWalk.Server.Controllers
{
    ...
    public class VenueController : BaseController
    {
        ...
        public ActionResult List() {
            ...
            return View(_entityService.GetUserEntities(user.Record, EntityType.Venue, 0, SmartWalkSettings.InitialItemsLoad, null, e => e.Name, false));
        }
        ...
        public ActionResult GetVenues(int pageNumber)
        {
            ...
            return Json(_entityService.GetUserEntities(user.Record, EntityType.Venue, pageNumber, SmartWalkSettings.ItemsLoad, null, e => e.Name, false));
        }
